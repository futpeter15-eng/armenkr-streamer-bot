...
# en el mismo canal 🔴・redes-y-directos. ARMENKR no duplica esos avisos.
...
BLUEPRINT: Dict[str, List[Tuple[str, str]]] = {
    "👑・𝐈𝐍𝐈𝐂𝐈𝐎": [
        ("👋・bienvenida", "Bienvenida e información esencial de la comunidad."),
        ("📜・reglas-y-roles", "Reglas rápidas y selección de roles."),
        ("📢・anuncios", "Anuncios oficiales y novedades importantes."),
        ("🔴・redes-y-directos", "Twitch + YouTube por Streamcord · TikTok por Noti · redes oficiales ARMENKR."),
    ],
    "🎬・𝐂𝐎𝐍𝐓𝐄𝐍𝐈𝐃𝐎": [
        ("💡・ideas", "Ideas, hooks, guiones y oportunidades de contenido."),
        ("🎞️・clips", "Clips pendientes, material para editar y videos terminados."),
        ("🤖・comandos-bot", "Comandos y herramientas de ARMENKR."),
    ],
    "⚽・𝐅𝐂 𝟐𝟕": [
        ("📰・noticias-fc", "Noticias oficiales de EA SPORTS FC 27 detectadas automáticamente cada pocos minutos."),
        ("🛠️・parches-fc", "Title Updates, gameplay changes, hotfixes y notas de parche oficiales."),
        ("✨・nuevo-contenido", "Ultimate Team, The Grounds, campañas, temporadas, recompensas y novedades para contenido rápido."),
    ],
    "💬・𝐂𝐎𝐌𝐔𝐍𝐈𝐃𝐀𝐃": [
        ("💬・chat", "Chat general de la comunidad."),
        ("😂・memes-y-clips", "Memes, clips, fails y momentos de la comunidad."),
    ],
    "🎮・𝐆𝐀𝐌𝐈𝐍𝐆": [
        ("🎮・otros-juegos", "GTA, Minecraft, ARK y juegos fuera de FC27."),
    ],
    "🔒・𝐀𝐌𝐈𝐆𝐎𝐒": [
        ("💬・chat-amigos", "Chat privado para amigos."),
        ("📅・planes", "Planes, salidas y organización entre amigos."),
        ("😂・fotos-y-memes", "Fotos, memes y cosas del grupo privado."),
    ],
    "🛡️・𝐒𝐓𝐀𝐅𝐅": [
        ("🛡️・staff", "Chat privado de administración y moderación."),
        ("📋・logs", "Logs y avisos internos del bot."),
        ("🗄️・datos-bot", "Datos internos de ARMENKR. No borrar."),
    ],
}
...
VOICE_CHANNELS = {
    "💬・𝐂𝐎𝐌𝐔𝐍𝐈𝐃𝐀𝐃": ["General"],
    "🎮・𝐆𝐀𝐌𝐈𝐍𝐆": ["Gaming"],
    "🔒・𝐀𝐌𝐈𝐆𝐎𝐒": ["Sala de amigos", "Gaming amigos"],
}
...
OLD_CHANNEL_MAP = {
    "bienvenidas": "👋・bienvenida", "bienvenida": "👋・bienvenida",
    "normativas": "📜・reglas-y-roles", "reglas": "📜・reglas-y-roles", "reglas-y-roles": "📜・reglas-y-roles", "roles": "📜・reglas-y-roles",
    "anuncios-akr": "📢・anuncios", "anuncios": "📢・anuncios", "noticias-crudas": "📢・anuncios",
    "redes-sociales": "🔴・redes-y-directos", "redes-oficiales": "🔴・redes-y-directos", "en-vivo": "🔴・redes-y-directos", "redes-y-en-vivo": "🔴・redes-y-directos", "redes-y-directos": "🔴・redes-y-directos",
    "ideas-y-guiones": "💡・ideas", "ideas-generadas": "💡・ideas", "hooks-y-guiones": "💡・ideas", "titulos-captions-hashtags": "💡・ideas", "contenido-para-hoy": "💡・ideas", "ideas-rapidas": "💡・ideas", "ideas-aprobadas": "💡・ideas", "pendiente-de-grabar": "💡・ideas", "ideas": "💡・ideas",
    "pendiente-de-editar": "🎞️・clips", "clips-para-editar": "🎞️・clips", "videos-listos": "🎞️・clips", "publicado-hoy": "🎞️・clips", "miniaturas-overlays": "🎞️・clips", "clips": "🎞️・clips",
    "comandos-akr": "🤖・comandos-bot", "comandos": "🤖・comandos-bot", "comandos-bot": "🤖・comandos-bot",
    "noticias-fc27": "📰・noticias-fc", "noticias-fc": "📰・noticias-fc",
    "parches-fc": "🛠️・parches-fc", "patch-notes": "🛠️・parches-fc",
    "fc27": "✨・nuevo-contenido", "ultimate-team": "✨・nuevo-contenido", "the-grounds": "✨・nuevo-contenido", "tacticas": "✨・nuevo-contenido", "noticias-ultimate-team": "✨・nuevo-contenido", "noticias-the-grounds": "✨・nuevo-contenido", "nuevo-contenido": "✨・nuevo-contenido",
    "chat": "💬・chat", "clips-comunidad": "😂・memes-y-clips", "memes": "😂・memes-y-clips", "memes-fc": "😂・memes-y-clips", "memes-y-clips": "😂・memes-y-clips",
    "gta": "🎮・otros-juegos", "gta-clips": "🎮・otros-juegos", "coches-y-tuning": "🎮・otros-juegos", "ark": "🎮・otros-juegos", "ark-parches": "🎮・otros-juegos", "minecraft": "🎮・otros-juegos", "otros-juegos": "🎮・otros-juegos",
    "chat-admins": "🛡️・staff", "control-staff": "🛡️・staff", "comandos-staff": "🛡️・staff", "staff": "🛡️・staff",
    "warns": "📋・logs", "logs": "📋・logs", "datos-bot": "🗄️・datos-bot",
    "chat-amigos": "💬・chat-amigos", "planes": "📅・planes", "fotos-y-memes": "😂・fotos-y-memes",
}

# Categorías de setups anteriores. /setup_discord_limpio elimina las que sobren.
LEGACY_CATEGORIES = {
    "👑 AKR HQ", "🎬 CONTENIDO", "⚽ FC27", "💬 COMUNIDAD", "🎮 EXTRA", "🛡️ STAFF", "👑・INICIO", "🎬・CONTENIDO", "💬・COMUNIDAD", "🎮・GAMING", "🔒・AMIGOS", "🛡️・STAFF",
...
def register_akr_content(bot, guild_id: int):
    ...
    async def _load_marker(guild: discord.Guild, marker: str) -> Optional[dict]:
        ch = get_text_channel_by_name(guild, "📋・logs")
        if not ch:
            return None
        try:
    ...
    async def check_fc_news_once() -> int:
        ...
        role = discord.utils.get(guild.roles, name="⚽・𝐅𝐂𝟐𝟕")
        ideas_ch = get_text_channel_by_name(guild, "💡・ideas")
        sent = 0
        ...
        for title, url, h in reversed(new_rows):
            ...
            if kind == "patch":
                ch = get_text_channel_by_name(guild, "🛠️・parches-fc")
                label, emoji, colour = "PARCHE / UPDATE", "🛠️", 0xE67E22
            elif kind == "content":
                ch = get_text_channel_by_name(guild, "✨・nuevo-contenido")
                label, emoji, colour = "NUEVO CONTENIDO", "✨", 0x2ECC71
            else:
                ch = get_text_channel_by_name(guild, "📰・noticias-fc")
            ...
            embed = discord.Embed(
                title=f"{emoji} {title}",
                description=(
                    f"**{label} detectado automáticamente.**\n\n"
                    "Fuente: sitio oficial de EA SPORTS FC 27.\n"
                    "Úsalo rápido para Short, TikTok, Reel o video antes de que se sature el tema."
                ),
                url=url,
                colour=discord.Colour(colour),
            )
            embed.add_field(name="🎥 Oportunidad", value="Abre el enlace, confirma los detalles y graba tu reacción/resumen cuanto antes.", inline=False)
            embed.set_footer(text="ARMENKR • FC27 News Monitor")
            try:
                await ch.send(
            ...
            if ideas_ch:
                idea_embed = discord.Embed(
                    title="🚨 IDEA RÁPIDA DESDE NOTICIA FC27",
                    description=f"**Tema:** {title}\n**Fuente:** {url}",
                    colour=discord.Colour.gold(),
                )
                idea_embed.add_field(name="Hook 1", value="Esto acaba de cambiar en FC27 y tienes que saberlo.", inline=False)
                idea_embed.add_field(name="Hook 2", value="EA acaba de anunciar esto para FC27.", inline=False)
    ...
    async def _send_live_alert(guild: discord.Guild, platform: str, info: dict, configured_url: str) -> None:
        ch = get_text_channel_by_name(guild, "🔴・redes-y-directos")
        if not ch:
            return
        role = discord.utils.get(guild.roles, name="🔔・𝐃𝐈𝐑𝐄𝐂𝐓𝐎𝐒")
    ...
    async def check_rss_feeds_once() -> int:
        ...
        for feed in feeds:
            ...
            for entry in reversed(entries):
                ...
                ideas_ch = get_text_channel_by_name(channel.guild, "💡・ideas")
                if ideas_ch:
    ...
    async def _apply_clean_layout(guild: discord.Guild, *, delete_extras: bool = False):
        ...
        # Roles mínimos. No borramos roles existentes para no romper permisos de otras funciones.
        ...
        special_candidates = {
            "📜・reglas-y-roles": getattr(guild, "rules_channel", None),
            "📢・anuncios": getattr(guild, "public_updates_channel", None),
        }
        ...
        for category_name, channels in BLUEPRINT.items():
            ...
            if category is None:
                try:
                    kwargs = {}
                    if category_name == "🛡️・𝐒𝐓𝐀𝐅𝐅":
                        kwargs["overwrites"] = _staff_overwrites_light(guild)
                    elif category_name == "🔒・𝐀𝐌𝐈𝐆𝐎𝐒":
        ...
        for category_name, voice_names in VOICE_CHANNELS.items():
            ...
            for voice_name in voice_names:
                ...
                if existing is None:
                    ...
                    aliases = {
                        "General": {"voz-general", "general", "voz", "general-voz"},
                        "Gaming": {"gaming", "gaming-general"},
                        "Sala de amigos": {"sala-de-amigos", "amigos", "voz-amigos"},
                        "Gaming amigos": {"gaming-amigos", "gaming-amigos-voz"},
                    }.get(voice_name, set())
                    existing = next(
                ...
                overwrites = _friends_overwrites_light(guild) if category_name == "🔒・𝐀𝐌𝐈𝐆𝐎𝐒" else None
                if existing is None:
                    try:
    ...
    async def setup_discord_final(interaction: discord.Interaction):
        ...
        fc_role = discord.utils.get(guild.roles, name="⚽・𝐅𝐂𝟐𝟕")
        ...
        summary = (
            ...
            "• Diseño visual uniforme con emojis y categorías compactas.\n"
            "• Área 🔒 Amigos privada.\n"
    ...
    async def archivar_akr_pesado(interaction: discord.Interaction):
        await interaction.response.send_message(
            "ℹ️ Este diseño ya no usa archivo. Para dejar el servidor limpio usa `/setup_discord_limpio`; "
    ...
    async def _publish_final_panels(guild: discord.Guild) -> List[str]:
        ...
        rules_ch = get_text_channel_by_name(guild, "📜・reglas-y-roles")
        social_ch = get_text_channel_by_name(guild, "🔴・redes-y-directos")
        cmd_ch = get_text_channel_by_name(guild, "🤖・comandos-bot")
        fc_ch = get_text_channel_by_name(guild, "📰・noticias-fc")
        posted = []

        if welcome_ch:
            embed = discord.Embed(
                title="👑 Bienvenido a ARMENKR",
                description=(
                    "FC27, gaming, directos y comunidad sin llenar el servidor de canales innecesarios.\n\n"
                    "Empieza en **📜・reglas-y-roles**, habla en **💬・chat** y activa las notificaciones que te interesen.\n\n"
                    "**Foco. Disciplina. Victoria.**"
                ),
                colour=discord.Colour.gold(),
            )
            embed.set_footer(text="ARMENKR FINAL • BIENVENIDA")
        ...
        if rules_ch:
            embed = discord.Embed(
                ...
                description=(
                    "**1.** Respeto primero.\n"
                    "**2.** Cero spam, estafas o links sospechosos.\n"
                    "**3.** Nada de racismo, acoso o toxicidad pesada.\n"
                    "**4.** Usa cada canal para lo que es; mantengamos el Discord limpio.\n"
                    "**5.** Clips, ideas y opiniones sí; drama innecesario no.\n"
                    "**6.** El área **🔒 Amigos** es privada y solo entra el rol de Amigos."
                ),
                colour=discord.Colour.red(),
            )
            embed.set_footer(text="ARMENKR FINAL • REGLAS")
            if await _replace_panel(rules_ch, "ARMENKR FINAL • REGLAS", embed):
                posted.append("📜・reglas-y-roles")

        if social_ch:
            embed = discord.Embed(
                title="🔴 ARMENKR — Redes y directos",
                description="Todos los avisos de directo viven en **un solo canal** para mantener el servidor limpio.",
                colour=discord.Colour.red(),
            )
            ...
            embed.add_field(
                ...
                value="**Streamcord:** Twitch + YouTube\n**Noti:** TikTok LIVE\nConfigura ambos bots para publicar aquí: `🔴・redes-y-directos`.",
                inline=False,
            )
            embed.set_footer(text="ARMENKR FINAL • REDES")
            if await _replace_panel(social_ch, "ARMENKR FINAL • REDES", embed, pin=True):
                posted.append("🔴・redes-y-directos")

        if fc_ch:
            embed = discord.Embed(
                title="⚽ FC27 — Radar de contenido",
                description=(
                    f"ARMENKR revisa automáticamente la página oficial de EA SPORTS FC 27 aproximadamente cada **{FC_NEWS_CHECK_MINUTES} min**.\n\n"
                    "Lo nuevo se separa entre **📰 noticias**, **🛠️ parches** y **✨ nuevo contenido**. "
                    "Además manda una idea rápida a **💡・ideas** para que puedas reaccionar/grabar rápido."
                ),
            ...
            embed.set_footer(text="ARMENKR FINAL • FC27 RADAR")
            if await _replace_panel(fc_ch, "ARMENKR FINAL • FC27 RADAR", embed, pin=True):
                posted.append("📰・noticias-fc")

        if cmd_ch:
            embed = discord.Embed(
                title="🤖 Comandos útiles ARMENKR",
                description=(
                    ...
                    "`/analizar_noticia noticia` — convierte noticia en contenido\n"
                    "`/fc_check_now` — revisa EA SPORTS FC 27 ahora\n"
                    "`/server_audit` — revisa el servidor\n"
                    "`/setup_discord_final` — aplica el diseño final y limpia lo innecesario"
                ),
                colour=discord.Colour.blue(),
            )
            embed.set_footer(text="ARMENKR FINAL • COMANDOS")
            if await _replace_panel(cmd_ch, "ARMENKR FINAL • COMANDOS", embed):
                posted.append("🤖・comandos-bot")
    ...
    async def configurar_directos(
        ...
        if not changed:
            await interaction.followup.send("ℹ️ No enviaste ningún enlace. Puedes poner `quitar` para eliminar uno.", ephemeral=True)
            return
