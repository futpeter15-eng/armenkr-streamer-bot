...
async def organizar_cmd(interaction: discord.Interaction):
    ...
    await group_existing_bots(guild)
...
async def on_ready():
    ...
    # /setup_akr_content aplica el nuevo setup ligero cuando tú lo decidas.
    try:
        await load_activity_cache(guild)
        await update_top_community(guild)
        await refresh_activity_panel(guild)
        print("✅ ARMENKR + AKR listo. No se hicieron cambios estructurales automáticos.")
    except Exception as exc:
