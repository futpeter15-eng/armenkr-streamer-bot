...
CH_WELCOME = "👋・bienvenida"
CH_RULES = "📜・reglas-y-roles"
CH_SOCIALS = "🔴・redes-y-directos"
CH_LIVE = "🔴・redes-y-directos"
CH_ANNOUNCE = "📢・anuncios"
CH_ROLES = "📜・reglas-y-roles"
...
CH_DRAWINGS = "🎨・𝑫𝒊𝒃𝒖𝒋𝒐𝒔"
CH_MEMES = "😂・memes-y-clips"
CH_CLIPS = "🎞️・clips"

CH_FRIENDS_CHAT = "💬・chat-amigos"
...
CH_BOT_COMMANDS = "🤖・comandos-bot"
CH_BOT_MUSIC = "🎵・𝑴𝒖́𝒔𝒊𝒄𝒂-𝑩𝒐𝒕"
CH_BOT_LEVELS = "📊・𝑵𝒊𝒗𝒆𝒍𝒆𝒔-𝑩𝒐𝒕"
CH_BOT_SETUP = "🧰・𝑪𝒐𝒏𝒇𝒊𝒈-𝑩𝒐𝒕𝒔"

CH_VIP_CHAT = "💎・𝒗𝒊𝒑-𝒄𝒉𝒂𝒕"
CH_VIP_GIVEAWAYS = "🎁・𝒔𝒐𝒓𝒕𝒆𝒐𝒔-𝒗𝒊𝒑"
VOICE_VIP = "🔊・𝐕𝐈𝐏 𝐋𝐎𝐔𝐍𝐆𝐄"

CH_STAFF_CHAT = "🛡️・staff"
...
async def refresh_panels(guild):
    ...
    if ch:
        embed = discord.Embed(
            title="🧰 𝐁𝐎𝐓𝐒 𝐏𝐀𝐑𝐀 𝐓𝐄𝐑𝐌𝐈𝐍𝐀𝐑 𝐄𝐋 𝐒𝐄𝐑𝐕𝐈𝐃𝐎𝐑",
            description=(
...
async def organizar_cmd(interaction: discord.Interaction):
    if not isinstance(interaction.user, discord.Member) or not interaction.user.guild_permissions.administrator:
        ...
        return
    await interaction.response.send_message(
        "ℹ️ El organizador antiguo quedó desactivado para no volver a llenar el Discord. "
